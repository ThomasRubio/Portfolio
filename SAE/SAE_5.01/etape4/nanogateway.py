...
class NanoGateway:
    ...
    def start(self):
        ...
        # set the 3 default channels to the same frequency (must be before sending the join request)
        self.lora.add_channel(0, frequency=903900000, dr_min=0, dr_max=3)
        self.lora.add_channel(1, frequency=903900000, dr_min=0, dr_max=3)
        self.lora.add_channel(2, frequency=903900000, dr_min=0, dr_max=3)
